...
client = MongoClient(mongo_uri)
db = client['sentiment_db']  # Replace with your actual database name if different
collection = db['sentiments']  # Replace with your actual collection name if different
...
def index():
    if request.method == 'POST':
        ...
        # Map BERT labels to simpler sentiments
        sentiment = 'Positive' if sentiment_label == 'POSITIVE' else 'Negative' if sentiment_label == 'NEGATIVE' else 'Neutral'
